@extends('layout.app') @section('title', 'Home') @section('css')
...
@endsection @section('content') @include('pages.home.header')
@include('pages.home.skills') @include('pages.home.tech-stack')
@include('pages.home.design-softwares') @include('pages.home.top-projects-it')
@include('pages.home.top-projects-arts') @include('pages.home.get-in-touch')
@endsection
